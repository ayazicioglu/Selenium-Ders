...
public class C04_BeforeAfterClass {
    ...
    public void test01(){
        ...
        }else System.out.println("URL amazon icermiyor test FAILED");
    }
    ...
    public void test02(){
        ...
        String actualIcerik=sonucElement.getText();

        if (actualIcerik.contains(expectedIcerik)){
            System.out.println("Nutella testi PASSED");
        }else System.out.println("Nutella testi FAILED");
    }
    ...
    public void test03(){
        ...
        WebElement urunIsimelement=driver.findElement(By.xpath("//span[@class='a-size-large product-title-word-break']"));
        String expectedIcerik="Nutella";
        String actualIsim=urunIsimelement.getText();

        if (actualIsim.contains(expectedIcerik)){
